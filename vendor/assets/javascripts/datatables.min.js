 ...
 *   https://datatables.net/download/#bs-3.3.5/jq-2.1.4,dt-1.10.10,b-1.1.0,b-colvis-1.1.0,cr-1.3.0,fc-3.2.0,fh-3.1.0,kt-2.1.0,r-2.0.0,sc-1.4.0,se-1.1.0
 *
 * Included libraries:
 *   jQuery 2.1.4, Bootstrap 3.3.5, DataTables 1.10.10, Buttons 1.1.0, Column visibility 1.1.0, ColReorder 1.3.0, FixedColumns 3.2.0, FixedHeader 3.1.0, KeyTable 2.1.0, Responsive 2.0.0, Scroller 1.4.0, Select 1.1.0
 */
...
m.ext=s={buttons:{},classes:{},build:"bs-3.3.5/jq-2.1.4,dt-1.10.10,b-1.1.0,b-colvis-1.1.0,cr-1.3.0,fc-3.2.0,fh-3.1.0,kt-2.1.0,r-2.0.0,sc-1.4.0,se-1.1.0",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},header:{}},order:{},type:{detect:[],search:{},order:{}},_unique:0,fnVersionCheck:m.fnVersionCheck,iApiIndex:0,oJUIClasses:{},sVersion:m.version};h.extend(s,{afnFiltering:s.search,aTypes:s.type.detect,ofnSearch:s.type.search,oSort:s.type.order,afnSortData:s.order,aoFeatures:s.feature,oApi:s.internal,oStdClasses:s.classes,
